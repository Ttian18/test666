        ...
        <div className="max-w-6xl mx-auto px-6 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Experience the enhanced design system with paper textures,
              improved animations, and responsive navigation
            </p>
          </div>
          ...
          <div className="themed-card p-8 mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              Scroll down this page to see the navigation bar shrink to 80%
              width with transparent background and rounded borders.
            </p>
            ...
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="themed-card p-6">
                ...
                <p className="text-muted-foreground">
                  This content is here to demonstrate the scroll behavior. As
                  you scroll down, notice how the navigation bar smoothly
                  transitions to a more compact, rounded design with a
                  transparent background. The animation uses smooth cubic-bezier
