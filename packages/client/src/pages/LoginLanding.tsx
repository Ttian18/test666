          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="text-sm font-medium text-blue-800 mb-1">Demo Mode</h3>
                <p className="text-sm text-blue-700 mb-3">Use these test credentials to explore the app:</p>
                <div className="space-y-2 text-sm">
                  <div className="bg-white rounded-lg p-3 border border-blue-200">
                    <div className="font-mono text-blue-800">
                      <div><strong>Email:</strong> demo@mealmint.ai</div>
