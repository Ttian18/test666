...
const findMerchantCategory = (merchantName) => {
    ...
    // Food & Dining
    if (lowerCaseMerchant.includes("food") ||
    ...
    // Transportation
    if (lowerCaseMerchant.includes("gas") ||
    ...
    // Shopping
    if (lowerCaseMerchant.includes("shop") ||
    ...
    // Entertainment
    if (lowerCaseMerchant.includes("movie") ||
    ...
    // Subscriptions
    if (lowerCaseMerchant.includes("netflix") ||
        lowerCaseMerchant.includes("spotify") ||
    ...
    // Utilities
    if (lowerCaseMerchant.includes("electric") ||
    ...
    // Healthcare
    if (lowerCaseMerchant.includes("hospital") ||
    ...
    // Education
    if (lowerCaseMerchant.includes("school") ||
    ...
    // Travel
    if (lowerCaseMerchant.includes("hotel") ||
    ...
    // Housing
    if (lowerCaseMerchant.includes("rent") ||
    ...
    // Fitness & Wellness
    if (lowerCaseMerchant.includes("gym") ||
        lowerCaseMerchant.includes("yoga") ||
        lowerCaseMerchant.includes("fitness") ||
    ...
    // Personal Care
    if (lowerCaseMerchant.includes("salon") ||
    ...
    // Home & Garden
    if (lowerCaseMerchant.includes("hardware") ||
        lowerCaseMerchant.includes("home depot") ||
        lowerCaseMerchant.includes("lowes") ||
